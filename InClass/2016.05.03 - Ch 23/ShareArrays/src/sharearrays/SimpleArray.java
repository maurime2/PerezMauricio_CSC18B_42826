...
public class SimpleArray // CAUTION: NOT THREAD SAFE!
{
   ...
   public void add(int value)
   {
      int position = writeIndex; // store the write index
       int sleepyTime = generator.nextInt(2000);
       System.out.printf("%s will write %2d to element %d after sleeping %d milliseconds.%n", Thread.currentThread().getName(),value,position,sleepyTime);
      try
      {
